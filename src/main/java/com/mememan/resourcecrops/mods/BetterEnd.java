...
public class BetterEnd {
	public static void init(){
		if(Mods.checkMod(Mods.BetterEnd)==true || Mods.checkDevEnv()==true){
			...
			RegisterCrop.addCrop(Mods.BetterEnd, "mossy_glowshroom", Crops.MOSSY_GLOWSHROOM, Crops.MOSSY_GLOWSHROOM_ITEM, new String[]{BetterEndTex.LOG_MOSSY_GLOWSHROOM}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{MOSSY_GLOWSHROOM_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "pythadendron", Crops.PYTHADENDRON, Crops.PYTHADENDRON_ITEM, new String[]{BetterEndTex.LOG_PYTHADENDRON}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{PYTHADENDRON_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "end_lotus", Crops.END_LOTUS, Crops.END_LOTUS_ITEM, new String[]{BetterEndTex.LOG_END_LOTUS}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{END_LOTUS_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "lacugrove", Crops.LACUGROVE, Crops.LACUGROVE_ITEM, new String[]{BetterEndTex.LOG_LACUGROVE}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{LACUGROVE_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "dragon_tree", Crops.DRAGON_TREE, Crops.DRAGON_TREE_ITEM, new String[]{BetterEndTex.LOG_DRAGON_TREE}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{DRAGON_TREE_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "tenanea", Crops.TENANEA, Crops.TENANEA_ITEM, new String[]{BetterEndTex.LOG_TENANEA}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{TENANEA_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "helix_tree", Crops.HELIX_TREE, Crops.HELIX_TREE_ITEM, new String[]{BetterEndTex.LOG_HELIX_TREE}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{HELIX_TREE_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "umbrella_tree", Crops.UMBRELLA_TREE, Crops.UMBRELLA_TREE_ITEM, new String[]{BetterEndTex.LOG_UMBRELLA_TREE}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{UMBRELLA_TREE_LOG, Strings.Tier1}, true);
			RegisterCrop.addCrop(Mods.BetterEnd, "jellyshroom", Crops.JELLYSHROOM, Crops.JELLYSHROOM_ITEM, new String[]{BetterEndTex.LOG_JELLYSHROOM}, CropModelTypes.LOG, new Boolean[]{true,false}, new String[]{JELLYSHROOM_LOG, Strings.Tier1}, true);
