package com.mememan.resourcecrops.entity;
...
public class EntityGoldenRainbowChicken extends AnimalEntity {
   ...
   public EntityGoldenRainbowChicken(EntityType<? extends EntityGoldenRainbowChicken> entityType, World world) {
   ...
   public EntityGoldenRainbowChicken createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
      return null/*(GoldenRainbowChickenEntity)RAINBOW_CHICKEN.create(serverWorld)*/;
   }
