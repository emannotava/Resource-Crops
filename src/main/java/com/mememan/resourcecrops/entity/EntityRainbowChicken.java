...
public class EntityRainbowChicken extends AnimalEntity {
   ...
   public EntityRainbowChicken(EntityType<? extends EntityRainbowChicken> entityType, World world) {
   ...
   public EntityRainbowChicken createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
      return null/*(RainbowChickenEntity)RAINBOW_CHICKEN.create(serverWorld)*/;
   }
