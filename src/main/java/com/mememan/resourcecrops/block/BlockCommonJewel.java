...
public class BlockCommonJewel extends Block{
	...
	public BlockCommonJewel(String name, int hex){
		...
		RegisterRecipe.addIngotToBlockRecipe(Mods.ResourceCrops + ":" + NAME, new String[]{"c:" + name + "_gems"});
		RegisterRecipe.addBlockToIngotRecipe(Mods.ResourceCrops + ":" + NAME_GEM, new String[]{"c:" + name + "_blocks"});
